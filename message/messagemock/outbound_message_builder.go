...
//
//	mockgen -package=messagemock -destination=message/messagemock/outbound_message_builder.go -mock_names=OutboundMsgBuilder=OutboundMsgBuilder github.com/MetalBlockchain/metalgo/message OutboundMsgBuilder
//
