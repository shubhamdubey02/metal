...
//
//	mockgen -package=messagemock -destination=message/messagemock/outbound_message.go -mock_names=OutboundMessage=OutboundMessage github.com/MetalBlockchain/metalgo/message OutboundMessage
//
