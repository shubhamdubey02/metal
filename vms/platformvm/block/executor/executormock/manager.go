...
//
//	mockgen -source=vms/platformvm/block/executor/manager.go -destination=vms/platformvm/block/executor/executormock/manager.go -package=executormock -exclude_interfaces= -mock_names=Manager=Manager
//
