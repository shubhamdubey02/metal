...
//
//	mockgen -package=mempoolmock -destination=vms/platformvm/txs/mempool/mempoolmock/mempool.go -mock_names=Mempool=Mempool github.com/MetalBlockchain/metalgo/vms/platformvm/txs/mempool Mempool
//
