...
//
//	mockgen -package=avaxmock -destination=vms/components/avax/avaxmock/transferable_in.go -mock_names=TransferableIn=TransferableIn github.com/MetalBlockchain/metalgo/vms/components/avax TransferableIn
//
