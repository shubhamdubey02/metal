...
//
//	mockgen -package=avaxmock -destination=vms/components/avax/avaxmock/transferable_out.go -mock_names=TransferableOut=TransferableOut github.com/MetalBlockchain/metalgo/vms/components/avax TransferableOut
//
