...
//
//	mockgen -package=statemock -destination=vms/proposervm/state/statemock/state.go -mock_names=State=State github.com/MetalBlockchain/metalgo/vms/proposervm/state State
//
