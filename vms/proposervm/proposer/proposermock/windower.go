...
//
//	mockgen -package=proposermock -destination=vms/proposervm/proposer/proposermock/windower.go -mock_names=Windower=Windower github.com/MetalBlockchain/metalgo/vms/proposervm/proposer Windower
//
