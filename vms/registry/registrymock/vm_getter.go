...
//
//	mockgen -package=registrymock -destination=vms/registry/registrymock/vm_getter.go -mock_names=VMGetter=VMGetter github.com/MetalBlockchain/metalgo/vms/registry VMGetter
//
