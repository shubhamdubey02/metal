...
//
//	mockgen -package=registrymock -destination=vms/registry/registrymock/vm_registry.go -mock_names=VMRegistry=VMRegistry github.com/MetalBlockchain/metalgo/vms/registry VMRegistry
//
