...
//
//	mockgen -package=metricsmock -destination=vms/avm/metrics/metricsmock/metrics.go -mock_names=Metrics=Metrics github.com/MetalBlockchain/metalgo/vms/avm/metrics Metrics
//
