...
//
//	mockgen -package=trackermock -destination=snow/networking/tracker/trackermock/tracker.go -mock_names=Tracker=Tracker github.com/MetalBlockchain/metalgo/snow/networking/tracker Tracker
//
