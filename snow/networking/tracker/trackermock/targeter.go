...
//
//	mockgen -package=trackermock -destination=snow/networking/tracker/trackermock/targeter.go -mock_names=Targeter=Targeter github.com/MetalBlockchain/metalgo/snow/networking/tracker Targeter
//
