...
//
//	mockgen -package=blockmock -destination=snow/engine/snowman/block/blockmock/state_syncable_vm.go -mock_names=StateSyncableVM=StateSyncableVM github.com/MetalBlockchain/metalgo/snow/engine/snowman/block StateSyncableVM
//
