...
//
//	mockgen -package=blockmock -destination=snow/engine/snowman/block/blockmock/with_verify_context.go -mock_names=WithVerifyContext=WithVerifyContext github.com/MetalBlockchain/metalgo/snow/engine/snowman/block WithVerifyContext
//
