...
//
//	mockgen -package=hashingmock -destination=utils/hashing/hashingmock/hasher.go -mock_names=Hasher=Hasher github.com/MetalBlockchain/metalgo/utils/hashing Hasher
//
