...
//
//	mockgen -package=resourcemock -destination=utils/resource/resourcemock/user.go -mock_names=User=User github.com/MetalBlockchain/metalgo/utils/resource User
//
