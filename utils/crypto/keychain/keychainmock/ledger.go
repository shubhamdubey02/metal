...
//
//	mockgen -package=keychainmock -destination=utils/crypto/keychain/keychainmock/ledger.go -mock_names=Ledger=Ledger github.com/MetalBlockchain/metalgo/utils/crypto/keychain Ledger
//
