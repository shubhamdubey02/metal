...
//
//	mockgen -package=filesystemmock -destination=utils/filesystem/filesystemmock/reader.go -mock_names=Reader=Reader github.com/MetalBlockchain/metalgo/utils/filesystem Reader
//
